...
<!-- Mirrored from themes.2the.me/MStone/2.3.1/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Aug 2019 20:27:26 GMT -->
<head>
		<meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<meta name="description" content="">
		<meta name="author" content="">
		<title>Mark Stone - Template</title>
		<!-- Favicons-->
	...
	<body>
		...
		<div class="wrapper">
			...
			<!-- Page Header-->
			<section class="module-header full-height parallax bg-dark bg-dark-30 text-left" id="home" data-background="assets/images/module-9.jpg">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
